...
<div class="mb-6 animate-fade-in" style="animation-delay: 0.05s;">
    <div class="flex items-center gap-3 mb-2">
        ...
        <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Edit City</h1>
    </div>
    <p class="text-sm text-slate-500 ml-8">Update details for {{ $city->name }}.</p>
</div>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $city->name) }}" class="block w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#0f2557]/20 focus:border-[#0f2557] sm:text-sm transition-all outline-none bg-white" required>
                            @error('name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>
                    </div>

                    <div class="pt-2" x-data="{ isActive: '{{ old('is_active', $city->is_active) ? '1' : '0' }}' }">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-slate-900" id="modal-title">Delete City</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-slate-500">Are you sure you want to permanently delete this city? This will also affect any associated services or pricing.</p>
                                </div>
                            </div>
                        </div>
                    </div>
